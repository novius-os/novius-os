...
--
-- Structure de la table `os_blog_category`
--
...
-- --------------------------------------------------------
--
-- Structure de la table `os_blog_category_link`
--

CREATE TABLE IF NOT EXISTS `os_blog_category_link` (
...
-- --------------------------------------------------------
--
-- Structure de la table `os_comment`
--
...
-- --------------------------------------------------------
--
-- Structure de la table `os_media`
--

CREATE TABLE IF NOT EXISTS `os_media` (
...
-- --------------------------------------------------------
--
-- Structure de la table `os_media_folder`
--

CREATE TABLE IF NOT EXISTS `os_media_folder` (
...
-- --------------------------------------------------------
--
-- Structure de la table `os_media_link`
--

CREATE TABLE IF NOT EXISTS `os_media_link` (
...
-- --------------------------------------------------------
--
-- Structure de la table `os_page_root`
--
