# Novius OS [![Build Status](https://travis-ci.org/novius-os/novius-os.png?branch=master/chiba2)](https://travis-ci.org/novius-os/novius-os)
...
* Current version: Novius OS Chiba 2.3.2
