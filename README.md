# Novius OS [![Build Status](https://travis-ci.org/novius-os/novius-os.png?branch=master/chiba)](https://travis-ci.org/novius-os/novius-os)
...
* Current version: Novius OS Chiba 2 (rel)
...
and Git are required. [Alternative methods](http://docs.novius-os.org/en/chiba.1/install/install.html) are available.)
