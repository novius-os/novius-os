...
class Widget_Password extends \Fieldset_Field {
    ...
    public function __construct($name, $label = '', array $attributes = array(), array $rules = array(), \Fuel\Core\Fieldset $fieldset) {
		...
		$this->display[] = new \Fieldset_Field($name.'_verification', $label, $attributes, $rules, $fieldset);
        $this->verification = $fieldset->add_field(new Widget_Empty($name.'_verification', $label, array(), array(), $fieldset))
