...
(function ($) {
	...
	$.widget("wijmo.wijlightbox", {
		...
		_create: function () {
			...
			//$('<img></img>').addClass('wijmo-wijlightbox-image').appendTo(this.content);
		...
		destroy: function () {
			...
			// this._removeTextPane();
			// this.content.remove();

			// this.container.removeClass([
			// 'wijmo-wijlightbox',
			// 'wijmo-wijlightbox-dialog',
			// 'ui-widget'
			// ].join(' '));
		...
		_size: function (size, calcOnly) {
			...
			var width = o.width,
				height = o.height,
				playerWidth = this.container.data('playerwidth.wijlightbox') || width,
				playerHeight = this.container.data('playerheight.wijlightbox') || height,
        ...
        _close: function (rel) {
			...
			var complete = function () {
				...
				//$.wijmo.wijlightbox.overlay.resize();
				self.container.unbind('keypress.wijlightbox');
				self.container.removeData('open.wijlightbox');
				self.container.removeData('rect.wijlightbox');
				self.container.removeData('moving.wijlightbox');
